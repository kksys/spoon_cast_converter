...
class AppUnsupportedFileTypeDialog extends StatefulWidget {
  AppUnsupportedFileTypeDialog({Key? key}) : super(key: key);

  @override
  _AppUnsupportedFileTypeDialogState createState() => _AppUnsupportedFileTypeDialogState();
}

class _AppUnsupportedFileTypeDialogState extends State<AppUnsupportedFileTypeDialog> {
  @override
    ...
    return StoreConnector<AppState, _ViewModel>(
      ...
      builder: (context, viewModel) {
        return MacosAlertDialog(
          ...
          title: AppText(localizations.alertUnsupportedFileTypeTitle),
          message: AppText(localizations.alertUnsupportedFileTypeMessage),
