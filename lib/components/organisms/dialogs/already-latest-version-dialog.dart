...
class AppAlreadyLatestVersionDialog extends StatefulWidget {
  AppAlreadyLatestVersionDialog({Key? key}) : super(key: key);

  @override
  _AppAlreadyLatestVersionDialogState createState() => _AppAlreadyLatestVersionDialogState();
}

class _AppAlreadyLatestVersionDialogState extends State<AppAlreadyLatestVersionDialog> {
  @override
    ...
    return StoreConnector<AppState, _ViewModel>(
      ...
      builder: (context, viewModel) {
        return MacosAlertDialog(
          ...
          title: AppText(localizations.alertAlreadyLatestVersionTitle),
          message: AppText(localizations.alertAlreadyLatestVersionMessage),
