...
class AppFinishConvertSequenceDialog extends StatefulWidget {
  AppFinishConvertSequenceDialog({Key? key}) : super(key: key);

  @override
  _AppFinishConvertSequenceDialogState createState() => _AppFinishConvertSequenceDialogState();
}

class _AppFinishConvertSequenceDialogState extends State<AppFinishConvertSequenceDialog> {
  @override
    ...
    return StoreConnector<AppState, _ViewModel>(
      ...
      builder: (context, viewModel) {
        return MacosAlertDialog(
          ...
          title: AppText(localizations.alertFinishConvertSequenceTitle),
          message: AppText(localizations.alertFinishConvertSequenceMessage),
